...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-bBC9Knuv.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D82NHVVJ.js"),
    import("./start-BmH2lhgM.js"),
...
export {
  ...
  isServer as G,
  joinPaths as H,
  jsxRuntimeExports as I,
  last as J,
  matchContext as K,
  nullReplaceEqualDeep as L,
  parseHref as M,
  ...
  replaceEqualDeep as U,
  requireReactDom as V,
  resolveManifestCssLink as W,
  resolvePath as X,
  rewriteBasepath as Y,
  rootRouteId as Z,
  server as _,
